...
class Settings_Page
{
	...
	{
		\add_submenu_page('upload.php', \__('AI Image Renamer', 'ai-image-renamer'), \__('AI Image Renamer', 'ai-image-renamer'), 'manage_options', self::PAGE_SLUG, [$this, 'render_settings_page']);
	}
