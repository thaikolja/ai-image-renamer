...
final class DuplicateArrayKeySniff extends AbstractArrayDeclarationSniff {
	...
	public function processArray( File $phpcsFile ) {
		...
		$this->keysSeenLt8 = array();
		$this->keysSeenGt8 = array();
	...
	public function processKey( File $phpcsFile, $startPtr, $endPtr, $itemNr ) {
		 ...
		 */
		$this->keysSeenLt8[ $key ] = array(
			'item' => $itemNr,
			'ptr'  => $startPtr,
		);
		$this->keysSeenGt8[ $key ] = array(
			'item' => $itemNr,
			'ptr'  => $startPtr,
		);
	...
	public function processNoKey( File $phpcsFile, $startPtr, $itemNr ) {
		...
		$this->keysSeenLt8[ $this->currentMaxIntKeyLt8 ] = array(
			'item' => $itemNr,
			'ptr'  => $startPtr,
		);
		...
		$this->keysSeenGt8[ $this->currentMaxIntKeyGt8 ] = array(
			'item' => $itemNr,
			'ptr'  => $startPtr,
		);
	}
