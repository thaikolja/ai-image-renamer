...
final class Parentheses {
	 ...
	 */
	private static $extraParenthesesOwners = array(
		\T_ISSET => \T_ISSET,
		\T_UNSET => \T_UNSET,
		\T_EMPTY => \T_EMPTY,
		\T_EXIT  => \T_EXIT,
	 ...
	 */
	public static function getFirstOpener( File $phpcsFile, $stackPtr, $validOwners = array() ) {
		return self::nestedParensWalker( $phpcsFile, $stackPtr, $validOwners, false );
	}
	 ...
	 *                   the token is not nested in parentheses at all.
	 */
	public static function getFirstCloser( File $phpcsFile, $stackPtr, $validOwners = array() ) {
	 ...
	 *                   the token is not nested in parentheses at all.
	 */
	public static function getFirstOwner( File $phpcsFile, $stackPtr, $validOwners = array() ) {
		$opener = self::getFirstOpener( $phpcsFile, $stackPtr, $validOwners );
		if ( $opener !== false ) {
	 ...
	 *                   the token is not nested in parentheses at all.
	 */
	public static function getLastOpener( File $phpcsFile, $stackPtr, $validOwners = array() ) {
	 ...
	 *                   the token is not nested in parentheses at all.
	 */
	public static function getLastCloser( File $phpcsFile, $stackPtr, $validOwners = array() ) {
	 ...
	 *                   the token is not nested in parentheses at all.
	 */
	public static function getLastOwner( File $phpcsFile, $stackPtr, $validOwners = array() ) {
		$opener = self::getLastOpener( $phpcsFile, $stackPtr, $validOwners );
		if ( $opener !== false ) {
			return self::getOwner( $phpcsFile, $opener );
		}
	 ...
	 *                   the token is not nested in parentheses at all.
	 */
	private static function nestedParensWalker( File $phpcsFile, $stackPtr, $validOwners = array(), $reverse = false ) {
		$tokens = $phpcsFile->getTokens();
