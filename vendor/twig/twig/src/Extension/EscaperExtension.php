...
final class EscaperExtension extends AbstractExtension {
	...
	public function getTokenParsers(): array {
		return array( new AutoEscapeTokenParser() );
	}

	public function getNodeVisitors(): array {
		return array( new EscaperNodeVisitor() );
	}

	public function getFilters(): array {
		return array(
			new TwigFilter( 'escape', array( EscaperRuntime::class, 'escape' ), array( 'is_safe_callback' => array( self::class, 'escapeFilterIsSafe' ) ) ),
			new TwigFilter( 'e', array( EscaperRuntime::class, 'escape' ), array( 'is_safe_callback' => array( self::class, 'escapeFilterIsSafe' ) ) ),
			new TwigFilter(
				'raw',
				null,
				array(
					'is_safe'    => array( 'all' ),
					'node_class' => RawFilter::class,
				)
			),
		);
	}
	...
	public function setDefaultStrategy( $defaultStrategy ): void {
		if ( 'name' === $defaultStrategy ) {
			$defaultStrategy = array( FileExtensionEscapingStrategy::class, 'guess' );
		}
