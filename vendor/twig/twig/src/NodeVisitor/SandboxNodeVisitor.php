...
final class SandboxNodeVisitor implements NodeVisitorInterface {
	...
	public function leaveNode( Node $node, Environment $env ): ?Node {
		if ( $node instanceof ModuleNode ) {
			...
			$node->setNode( 'constructor_end', new Nodes( array( new CheckSecurityCallNode(), $node->getNode( 'constructor_end' ) ) ) );
			$node->setNode( 'class_end', new Nodes( array( new CheckSecurityNode( $this->filters, $this->tags, $this->functions ), $node->getNode( 'class_end' ) ) ) );
		} elseif ( $this->inAModule ) {
