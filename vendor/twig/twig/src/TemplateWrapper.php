...
final class TemplateWrapper {
	 ...
	 */
	public function stream( array $context = array() ): iterable {
	 ...
	 * @return iterable<scalar|\Stringable|null>
	 */
	public function streamBlock( string $name, array $context = array() ): iterable {
	...
	public function display( array $context = array() ) {
		...
		$this->template->display( $context, \func_get_args()[1] ?? array() );
	}
